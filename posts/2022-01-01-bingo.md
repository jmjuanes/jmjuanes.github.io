    ...
    const ui = {
        ...
        Tabs: props => {
            const content = (props.items || []).map(item => {
                ...
                return kofi.html`
                    <div className="${className}" onClick="${() => props.onClick(currentItem)}">
        ...
        CurrentCallBall: props => kofi.html`
            <div key="${props.current}" class="w-full p-4 bg-white rounded-3xl flex items-center flex-col gap-4">
                ...
                <div class="text-center text-sm font-bold">${props.total} / ${MAX_NUMBERS}</div>
            </div>
        `,
            ...
            <div className="w-full h-full flex items-center justify-center">
                <div className="max-w-md w-full flex flex-col items-center">
                    ...
                    <div className="w-full mb-4">
                        ...
                        ${ui.Tabs({ items: availableLanguages, activeItem: state.language, onClick: onLanguageChange })}
                    </div>
            ...
            <div className="w-full h-full min-h-0 flex flex-col md:flex-row gap-4 p-4">
                <div className="w-full flex flex-col justify-between px-4">
                    <div className="flex flex-col gap-2 h-full">
                        ${state.currentCall > -1 ? ui.CurrentCallBall({ current: state.calls[state.currentCall], count: state.currentCall + 1 }) : ""}
