...
<script type="module">
    ...
    const ui = {
        Button: (text, onClick) => kofi.html`
            <button className="w-full bg-gray-950 hover:bg-gray-900 text-white text-lg text-center p-4 border-0 rounded-full" onClick="${onClick}">
                <span>${text}</span>
            </button>
        `,
    ...
    bus.on("render:welcome", () => {
        const content = kofi.html`
            <div className="w-full h-full flex items-center justify-center">
                <div className="max-w-lg w-full flex flex-col items-center">
                    <div className="font-bold text-2xl text-center mb-4">bingo.</div>
                    ${ui.Button("Play", () => null)}
                </div>
            </div>
        `;
