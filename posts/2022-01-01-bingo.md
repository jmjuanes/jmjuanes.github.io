...
<script type="module">
    ...
    const ui = {
        ...
        CurrentCallBall: (ballNumber, ballCount) => kofi.html`
            <div class="w-full p-4 bg-white rounded-3xl flex items-center flex-col gap-4">
                <div class="shadow-md bg-white border-gray-900 border-8 rounded-full w-56 h-56 flex items-center justify-center">
                    <div class="bg-gray-900 rounded-full w-48 h-48 flex flex-col items-center justify-center">
                ...
                <div class="text-center text-xs font-medium">${ballCount} / 90</div>
            </div>
        `,
                ...
                <div className="w-full flex flex-col justify-between px-4">
                    <div className="flex flex-col gap-2 h-full">
                        ...
                        ${lastCalls.length > 0 ? kofi.html`
                            <div className="w-full p-4 bg-gray-100 rounded-3xl flex items-center flex-col gap-2">
                                <div className="w-full grid grid-cols-5 items-center gap-2">
                                    ${lastCalls.map(number => ui.LastCallBall(number))}
                                </div>
                                <div className="text-center text-gray-700 text-xs font-medium">${t("lastCalls")}</div>
                            </div>
                        ` : ""}
                    </div>
                    <div className="flex flex-col gap-2">
                        ${ui.Button(state.status === GAME_STATUS.NOT_STARTED ? "game.start" : "game.pause", () => resumeGame())}
