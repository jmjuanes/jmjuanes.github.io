...
<script type="module">
    ...
    const ui = {
        PrimaryButton: (text, onClick) => kofi.html`
        ...
        `,
        SecondaryButton: (text, onClick) => kofi.html`
            <button className="w-full bg-white hover:bg-gray-100 border-2 border-gray-950 text-center p-4 border-0 rounded-full" onClick="${onClick}">
                <span className="text-lg font-bold">${t(text)}</span>
            </button>
        `,
        Separator: () => kofi.html`
            <div className="w-full border-2 border-gray-950 my-2"></div>
        `,
        ...
        const content = kofi.html`
            <div className="w-full h-full flex items-center justify-center">
                <div className="max-w-md w-full flex flex-col items-center">
                    ...
                    ${ui.PrimaryButton("play", onGameStart)}
                </div>
            </div>
        `;
            ...
            <div className="w-full h-full min-h-0 flex flex-col md:flex-row gap-4 p-4">
                <div className="w-full flex flex-col justify-between px-4">
                    ...
                    <div className="flex flex-col gap-2">
                        ${state.status !== GAME_STATUS.FINISHED ? ui.PrimaryButton(actionButtonLabel, () => resumeGame()) : ""}
                        ${ui.SecondaryButton("game.new", () => resetGame())}
                        ${ui.Separator()}
                        ${ui.SecondaryButton("game.exit", () => onGameExit())}
                    </div>
                </div>
