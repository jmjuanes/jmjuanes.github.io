    ...
    const FormOptions = {
        [FORM_TYPES.TEXT]: props => {
            const className = kofi.classNames({
                "block w-full bg-white border-1 border-gray-200 px-3 py-2 rounded-lg": true,
            });
                ...
                ${Object.keys(props.fields).map(field => kofi.html`
                    <div className="flex flex-col gap-2">
                        ${props.fields[field].title ? kofi.html`
                            <div className="font-bold">${pros.fields[field].title}</div>
                        ` : ""}
                ...
                <div className="w-full h-full min-h-0 flex flex-col">
                    ...
                    <div className="grow-1 h-full w-full flex items-stretch">
                        ...
                        ${app.state.activeElement ? kofi.html`
                            <div className="w-full max-w-md h-full bg-white shrink-0 border-r-1 border-gray-200 p-3">
                                ${ui.Form({
                                    data: app.state.activeElement,
                                    fields: ELEMENTS[app.state.activeElement.type],
