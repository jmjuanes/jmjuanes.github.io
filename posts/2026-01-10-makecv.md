                    ...
                    <div className="grow-1 h-full w-full flex items-stretch">
                        ...
                        <div className="relative w-full h-full py-4 px-2">
                            ${kofi.directives.when(app.state?.data?.elements?.length === 0, () => kofi.html`
                                <div className="border-1 border-dashed border-gray-200 w-full h-full flex items-center justify-center">
                                    <div className="max-w-lg w-full flex flex-col items-center gap-1">
                                        <div className="flex justify-center text-2xl bg-gray-100 rounded-xl p-2">
                                            ${ui.Icon({ icon: "article" })}
                                        </div>
                                        <div className="font-semibold text-center">Your resume is empty</div>
                                        <div className="opacity-60 text-center text-sm">Add new elements to get started.</div>
                                    </div>
                                </div>
                            `)}
                            ${kofi.directives.when(app.state?.data?.elements?.length > 0, () => kofi.html`
