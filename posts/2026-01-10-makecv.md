                ...
                <div className="w-full h-full min-h-0 flex flex-col bg-white">
                    ...
                    <div className="grow-1 h-full w-full flex items-stretch">
                        ...
                        <div className="relative w-full h-full p-4">
                            <div className="w-full h-full border-1 border-gray-200 overflow-scroll rounded-xl"></div>
                            <div className="absolute z-100 bottom-0 right-0 mb-4 mr-4">
                                <div className="bg-gray-100 rounded-full px-2 py-2 text-xs">Preview</div>
                            </div>
                        </div>
