            ...
            kofi.render(kofi.html`
                <div className="w-full h-full min-h-0 flex flex-col bg-white">
                    ...
                    <div className="grow-1 h-full w-full flex items-stretch">
                        ...
                        <div className="relative w-full h-full m-4 border-1 border-gray-200 overflow-scroll rounded-xl bg-white">
                            <div className="absolute z-100 bottom-0 right-0 mb-4 mr-4">
                                <div className="bg-gray-100 rounded-full px-3 py-2 text-sm">Preview</div>
                            </div>
                        </div>
